...
function handleClick(e) {
  ...
  return (
    ...
    <ul class="to-do-list">
        ...
        <div class="item"><li>ashbdjhwbhd</li><i class="fas fa-edit"></i><i class="fas fa-trash"></i></div><div class="item"><li>jdabwkhdbjawkb</li><i class="fas fa-edit"></i><i class="fas fa-trash"></i></div><div class="item"><li>dakjwhgdhkavgwhda</li><i class="fas fa-edit"></i><i class="fas fa-trash"></i></div><div class="item"><li>abwdhabwhj</li><i class="fas fa-edit"></i><i class="fas fa-trash"></i></div>
        </ul>
    </>
  );
}
